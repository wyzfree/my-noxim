...
int GlobalParams::chip_id = 0;
string GlobalParams::in_fifo_path  = "";
string GlobalParams::out_fifo_path = "";
bool   GlobalParams::snn_mode             = false;
int    GlobalParams::snn_timestep_cycles  = 100;
float  GlobalParams::snn_threshold        = 1.0f;
float  GlobalParams::snn_leak             = 0.9f;
float  GlobalParams::snn_weight_in        = 0.3f;
float  GlobalParams::snn_bias             = 0.15f;
vector<float> GlobalParams::snn_bias_per_chip = {};
int    GlobalParams::snn_fanout            = 4;
int    GlobalParams::snn_cross_chip_fanout = 0;
int    GlobalParams::snn_target_chip       = -1;
